...
import Header from '@/Components/Header'; // Optional: Include if your layout uses it

export default function OwnerLogin({ auth }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('login.owner'));
    };

    const handleGoogleLogin = () => {
        window.location.href = '/auth/google'; // Optional: Update if owners use Google login
    };
            ...
            <div className="min-h-screen bg-white text-black">
                ...
                <main className="flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                    <div className="w-full max-w-md space-y-6">
                        <h2 className="text-center text-3xl font-extrabold">Owner Login</h2>
